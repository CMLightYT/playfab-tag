...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "78275"  # Playfab Title Id
        self.SecretKey: str = "SWPJPOEPRD7FJF6SUD79I1Y71DPC8NS31QQOY16478H8A5EU87"  # Playfab Secret Key
        self.ApiKey: str = "OC|1344665717575655|87c383fa7d2997a0a3a38abeba3f18e1"  # App Api Key (Oculus/Graph API)
        ...
        <html>
            ...
            <body style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #004d00, #00cc00); color: white; text-align: center; padding: 50px;">
                <h1 style="color: #eedd82; font-size: 48px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">
                    Wsp Broskie. This is a private backend!
                </h1>
                <p style="font-size: 18px;">Playfab Tag Backend Server Running Smoothly!</p>
                <img src="https://aicdn.picsart.com/275c6ae1-73a4-4cee-b3f5-45ccfa4499ae.png" alt="if u see this text it works" style="max-width: 500px; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); display: block; margin: 30px auto;">
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/Ud9ScbbZbx</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/Ud9ScbbZbx</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/Ud9ScbbZbx</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/Ud9ScbbZbx</color>",
        ...
        "MOTD": "<color=#aa21cc>WELCOME TO PLAYFAB TAG!</color>\n\n<color=#0099c2>CURRENT UPDATE: CHRISTMAS24</color>\n<color=#ff00dd>BOOST THE DISCORD TO GET THE FOREST GUIDE STICK AND YOU GET TO MEET THE OWNERS WHENEVER YOU WANT!</color>\n<color=#5d5e5e>CMLIGHT MADE THIS MOTD</color>\n<color=#00b7ff>OUR OWNERS ARE FRENCH FRIES AND INFECTED</color>\n<color=#ac22e3>THANKS FOR PLAYING PLAYFAB TAG!</color>\n\n<color=#3766e6>discord.gg/Ud9ScbbZbx</color>",
        "TOBAlreadyOwnCompTxt": "DISCORD.GG/Ud9ScbbZbx",
        "TOBAlreadyOwnPurchaseBundle": "PLAYFAB TAG",
        "TOBDefCompTxt": "DISCORD.GG/Ud9ScbbZbx",
        "TOBDefPurchaseBtnDefTxt": "PLAYFAB TAG",
        # Legal and Versions
        "EnableCustomAuthentication": True,
        "LatestPrivacyPolicyVersion": "2024.09.20",
        "LatestTOSVersion": "2024.09.20",
        "TOS_2024.09.20": "DISCORD.GG/Ud9ScbbZbx",
        ...
        "NewsFeedUrl": "https://discord.gg/Ud9ScbbZbx",
        ...
        "BanAppealUrl": "https://discord.gg/Ud9ScbbZbx",
        ...
        "FeedbackSubmissionUrl": "https://discord.gg/Ud9ScbbZbx/feedback"
    }
